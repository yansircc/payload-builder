    ...
    <section className="py-32">
      <div className="container">
        <div className="flex flex-col items-center gap-4">
          ...
          <h2 className="text-center text-3xl font-semibold lg:text-4xl text-muted-foreground">
            {heading}
          </h2>
        ...
        <div className="mx-auto mt-20 max-w-screen-lg rounded-2xl bg-muted p-6 md:p-20">
          ...
          <q className="text-2xl font-semibold md:text-4xl text-foreground">{quote}</q>
          ...
          <div className="mt-6 flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-foreground">{authorRole}</p>
            </div>
          </div>
        </div>
      </div>
