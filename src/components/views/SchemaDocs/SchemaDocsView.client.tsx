...
interface SchemaDocsViewClientProps {
  user?: any
}

export const SchemaDocsViewClient: React.FC<SchemaDocsViewClientProps> = () => {
  return (
    <Gutter>
      <div className="py-10">
        ...
        <div className="mb-8">
          <p className="mb-4">
            ...
            (schema.org) to your pages and posts. Structured data helps search engines understand
            your content and can lead to rich results in search listings.
          </p>
        </div>
        ...
        <div className="bg-slate-100 p-6 rounded-lg mb-8">
          ...
          <p className="mb-4">
            By default, appropriate schema is generated automatically for each page and post based
            on its content:
          </p>
          <ul className="list-disc ml-6 mb-4">
            ...
            <li>
              <strong>Products</strong> - Product schema with image gallery, pricing, and
              availability
            </li>
            <li>
        ...
        <div className="bg-blue-50 p-6 rounded-lg mb-8 border border-blue-200">
          ...
          <ul className="list-disc ml-6 mb-4 text-blue-800">
            <li>
              <strong>Schema Organization</strong> - Multiple schemas are intelligently combined
              into a single @graph structure
            </li>
            <li>
              <strong>Schema Deduplication</strong> - Duplicate schema types are automatically
              removed
            </li>
            <li>
        ...
        <div className="bg-green-50 p-6 rounded-lg mb-8 border border-green-200">
          ...
          <p className="mb-4 text-green-800">
            Each page type has specialized schema implementation:
          </p>
          <ul className="list-disc ml-6 space-y-2 text-green-800">
            ...
            <li>
              <strong>Products</strong> - Adds product images, descriptions, and related product
              links
            </li>
            <li>
