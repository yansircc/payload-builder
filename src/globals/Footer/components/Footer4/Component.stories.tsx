...
import type { Footer4Fields } from '@/payload-types'
import Footer4 from './Component'

const meta: Meta<typeof Footer4> = {
  title: 'Globals/Footer/Footer4',
  component: Footer4,
  parameters: {
    layout: 'fullscreen',
  },
...
const defaultFooter: Footer4Fields['footer'] = {
  logo: {
    id: 'logo-1',
    alt: 'Company Logo',
    url: '/logo-dark.png',
  ...
  newsletter: {
    ...
    subtitle: 'Stay up to date with the latest news, updates, and exclusive offers',
  },
  sections: [
    {
      title: 'Products',
