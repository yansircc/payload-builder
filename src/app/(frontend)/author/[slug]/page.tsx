  ...
  return (
    <div className="container py-24">
      <Card className="mb-16 overflow-hidden">
        <div className="relative h-48 bg-gradient-to-r from-primary/20 to-secondary/20">
          <div className="absolute -bottom-16 left-8">
            <Avatar className="size-32 sm:size-48 border-4 border-background shadow-lg">
              {author.email ? (
                <AvatarImage
                  src={`https://www.gravatar.com/avatar/${author.email}`}
                  alt={author.username || ''}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {Object.entries(author.socialLinks).map(([platform, url]) => {
                      ...
                      return (
                        ...
                        >
                          <span className="text-primary">{icons[platform] || null}</span>
      ...
      <div className="space-y-8">
        <h2 className="text-2xl font-bold">Posts by {author.username}</h2>
