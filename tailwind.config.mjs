  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        ring: 'var(--ring)',
        success: 'var(--success)',
        'success-foreground': 'var(--successForeground)',
        warning: 'var(--warning)',
        'warning-foreground': 'var(--warningForeground)',
        error: 'var(--error)',
        'error-foreground': 'var(--errorForeground)',
        info: 'var(--info)',
        'info-foreground': 'var(--infoForeground)',
      },
      borderRadius: {
        sm: 'var(--radius-small)',
